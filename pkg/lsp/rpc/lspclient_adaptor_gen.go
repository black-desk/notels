...
func (a *LspClientJSONRPCAdaptor) Call(
	...
	if method == "workspace/workspaceFolders" {
		...
		tmpResult, code, methodErr = a.service.WorkspaceWorkspaceFolders(
			ctx,
		)
		call = true
	...
	if method == "workspace/configuration" {
		...
		tmpResult, code, methodErr = a.service.WorkspaceConfiguration(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "window/workDoneProgress/create" {
		...
		tmpResult, code, methodErr = a.service.WindowWorkDoneProgressCreate(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "workspace/semanticTokens/refresh" {
		...
		tmpResult, code, methodErr = a.service.WorkspaceSemanticTokensRefresh(
			ctx,
		)
		call = true
	...
	if method == "window/showDocument" {
		...
		tmpResult, code, methodErr = a.service.WindowShowDocument(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "workspace/inlineValue/refresh" {
		...
		tmpResult, code, methodErr = a.service.WorkspaceInlineValueRefresh(
			ctx,
		)
		call = true
	...
	if method == "workspace/inlayHint/refresh" {
		...
		tmpResult, code, methodErr = a.service.WorkspaceInlayHintRefresh(
			ctx,
		)
		call = true
	...
	if method == "workspace/diagnostic/refresh" {
		...
		tmpResult, code, methodErr = a.service.WorkspaceDiagnosticRefresh(
			ctx,
		)
		call = true
	...
	if method == "client/registerCapability" {
		...
		tmpResult, code, methodErr = a.service.ClientRegisterCapability(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "client/unregisterCapability" {
		...
		tmpResult, code, methodErr = a.service.ClientUnregisterCapability(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "window/showMessageRequest" {
		...
		tmpResult, code, methodErr = a.service.WindowShowMessageRequest(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "workspace/codeLens/refresh" {
		...
		tmpResult, code, methodErr = a.service.WorkspaceCodeLensRefresh(
			ctx,
		)
		call = true
	...
	if method == "workspace/applyEdit" {
		...
		tmpResult, code, methodErr = a.service.WorkspaceApplyEdit(
			ctx,
			tmpParams,
		)
		call = true
