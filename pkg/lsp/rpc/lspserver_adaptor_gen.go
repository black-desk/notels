...
func (a *LspServerJSONRPCAdaptor) Call(
	...
	if method == "textDocument/implementation" {
		...
		tmpResult, methodErr = a.service.TextDocumentImplementation(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/typeDefinition" {
		...
		tmpResult, methodErr = a.service.TextDocumentTypeDefinition(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/documentColor" {
		...
		tmpResult, methodErr = a.service.TextDocumentDocumentColor(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/colorPresentation" {
		...
		tmpResult, methodErr = a.service.TextDocumentColorPresentation(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/foldingRange" {
		...
		tmpResult, methodErr = a.service.TextDocumentFoldingRange(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/declaration" {
		...
		tmpResult, methodErr = a.service.TextDocumentDeclaration(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/selectionRange" {
		...
		tmpResult, methodErr = a.service.TextDocumentSelectionRange(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/prepareCallHierarchy" {
		...
		tmpResult, methodErr = a.service.TextDocumentPrepareCallHierarchy(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "callHierarchy/incomingCalls" {
		...
		tmpResult, methodErr = a.service.CallHierarchyIncomingCalls(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "callHierarchy/outgoingCalls" {
		...
		tmpResult, methodErr = a.service.CallHierarchyOutgoingCalls(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/semanticTokens/full" {
		...
		tmpResult, methodErr = a.service.TextDocumentSemanticTokensFull(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/semanticTokens/full/delta" {
		...
		tmpResult, methodErr = a.service.TextDocumentSemanticTokensFullDelta(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/semanticTokens/range" {
		...
		tmpResult, methodErr = a.service.TextDocumentSemanticTokensRange(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/linkedEditingRange" {
		...
		tmpResult, methodErr = a.service.TextDocumentLinkedEditingRange(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "workspace/willCreateFiles" {
		...
		tmpResult, methodErr = a.service.WorkspaceWillCreateFiles(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "workspace/willRenameFiles" {
		...
		tmpResult, methodErr = a.service.WorkspaceWillRenameFiles(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "workspace/willDeleteFiles" {
		...
		tmpResult, methodErr = a.service.WorkspaceWillDeleteFiles(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/moniker" {
		...
		tmpResult, methodErr = a.service.TextDocumentMoniker(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/prepareTypeHierarchy" {
		...
		tmpResult, methodErr = a.service.TextDocumentPrepareTypeHierarchy(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "typeHierarchy/supertypes" {
		...
		tmpResult, methodErr = a.service.TypeHierarchySupertypes(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "typeHierarchy/subtypes" {
		...
		tmpResult, methodErr = a.service.TypeHierarchySubtypes(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/inlineValue" {
		...
		tmpResult, methodErr = a.service.TextDocumentInlineValue(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/inlayHint" {
		...
		tmpResult, methodErr = a.service.TextDocumentInlayHint(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "inlayHint/resolve" {
		...
		tmpResult, methodErr = a.service.InlayHintResolve(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/diagnostic" {
		...
		tmpResult, tmpErrorData, methodErr = a.service.TextDocumentDiagnostic(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "workspace/diagnostic" {
		...
		tmpResult, tmpErrorData, methodErr = a.service.WorkspaceDiagnostic(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "initialize" {
		...
		tmpResult, tmpErrorData, methodErr = a.service.Initialize(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "shutdown" {
		...
		tmpResult, methodErr = a.service.Shutdown(ctx)
		call = true
	...
	if method == "textDocument/willSaveWaitUntil" {
		...
		tmpResult, methodErr = a.service.TextDocumentWillSaveWaitUntil(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/completion" {
		...
		tmpResult, methodErr = a.service.TextDocumentCompletion(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "completionItem/resolve" {
		...
		tmpResult, methodErr = a.service.CompletionItemResolve(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/hover" {
		...
		tmpResult, methodErr = a.service.TextDocumentHover(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/signatureHelp" {
		...
		tmpResult, methodErr = a.service.TextDocumentSignatureHelp(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/definition" {
		...
		tmpResult, methodErr = a.service.TextDocumentDefinition(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/references" {
		...
		tmpResult, methodErr = a.service.TextDocumentReferences(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/documentHighlight" {
		...
		tmpResult, methodErr = a.service.TextDocumentDocumentHighlight(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/documentSymbol" {
		...
		tmpResult, methodErr = a.service.TextDocumentDocumentSymbol(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/codeAction" {
		...
		tmpResult, methodErr = a.service.TextDocumentCodeAction(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "codeAction/resolve" {
		...
		tmpResult, methodErr = a.service.CodeActionResolve(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "workspace/symbol" {
		...
		tmpResult, methodErr = a.service.WorkspaceSymbol(ctx, tmpParams)
		call = true
	...
	if method == "workspaceSymbol/resolve" {
		...
		tmpResult, methodErr = a.service.WorkspaceSymbolResolve(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/codeLens" {
		...
		tmpResult, methodErr = a.service.TextDocumentCodeLens(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "codeLens/resolve" {
		...
		tmpResult, methodErr = a.service.CodeLensResolve(ctx, tmpParams)
		call = true
	...
	if method == "textDocument/documentLink" {
		...
		tmpResult, methodErr = a.service.TextDocumentDocumentLink(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "documentLink/resolve" {
		...
		tmpResult, methodErr = a.service.DocumentLinkResolve(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/formatting" {
		...
		tmpResult, methodErr = a.service.TextDocumentFormatting(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/rangeFormatting" {
		...
		tmpResult, methodErr = a.service.TextDocumentRangeFormatting(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/onTypeFormatting" {
		...
		tmpResult, methodErr = a.service.TextDocumentOnTypeFormatting(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/rename" {
		...
		tmpResult, methodErr = a.service.TextDocumentRename(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "textDocument/prepareRename" {
		...
		tmpResult, methodErr = a.service.TextDocumentPrepareRename(
			ctx,
			tmpParams,
		)
		call = true
	...
	if method == "workspace/executeCommand" {
		...
		tmpResult, methodErr = a.service.WorkspaceExecuteCommand(
			ctx,
			tmpParams,
		)
		call = true
