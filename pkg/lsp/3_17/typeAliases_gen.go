...
func (l*Location)isDefinition(){}

func (l*Location_Slice)isDefinition(){}

func lspgenUnmarshalJSONtoDefinition(
        raw json.RawMessage,
) (
        ret Definition,
        err error,
...
type ChangeAnnotationIdentifier any
