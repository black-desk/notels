...
var SemanticTokenTypesValidateSlice = []SemanticTokenTypes{
...
func (this *SemanticTokenTypes) Validate() error {
	for _, x := range SemanticTokenTypesValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var SemanticTokenModifiersValidateSlice = []SemanticTokenModifiers{
...
func (this *SemanticTokenModifiers) Validate() error {
	for _, x := range SemanticTokenModifiersValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var DocumentDiagnosticReportKindValidateSlice = []DocumentDiagnosticReportKind{
...
func (this *DocumentDiagnosticReportKind) Validate() error {
	for _, x := range DocumentDiagnosticReportKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var ErrorCodesValidateSlice = []ErrorCodes{
...
func (this *ErrorCodes) Validate() error {
	for _, x := range ErrorCodesValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var LSPErrorCodesValidateSlice = []LSPErrorCodes{
...
func (this *LSPErrorCodes) Validate() error {
	for _, x := range LSPErrorCodesValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var FoldingRangeKindValidateSlice = []FoldingRangeKind{
...
func (this *FoldingRangeKind) Validate() error {
	for _, x := range FoldingRangeKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var SymbolKindValidateSlice = []SymbolKind{
	SymbolKindFile,
	SymbolKindModule,
	SymbolKindNamespace,
	SymbolKindPackage,
...
func (this *SymbolKind) Validate() error {
	for _, x := range SymbolKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var SymbolTagValidateSlice = []SymbolTag{
	SymbolTagDeprecated,
}

func (this *SymbolTag) Validate() error {
	for _, x := range SymbolTagValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var UniquenessLevelValidateSlice = []UniquenessLevel{
...
func (this *UniquenessLevel) Validate() error {
	for _, x := range UniquenessLevelValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var MonikerKindValidateSlice = []MonikerKind{
	MonikerKindImport,
	MonikerKindExport,
	MonikerKindLocal,
}
...
func (this *MonikerKind) Validate() error {
	for _, x := range MonikerKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var InlayHintKindValidateSlice = []InlayHintKind{
	InlayHintKindType,
	InlayHintKindParameter,
}

func (this *InlayHintKind) Validate() error {
	for _, x := range InlayHintKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var MessageTypeValidateSlice = []MessageType{
	MessageTypeError,
	MessageTypeWarning,
	MessageTypeInfo,
	MessageTypeLog,
...
func (this *MessageType) Validate() error {
	for _, x := range MessageTypeValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var TextDocumentSyncKindValidateSlice = []TextDocumentSyncKind{
...
func (this *TextDocumentSyncKind) Validate() error {
	for _, x := range TextDocumentSyncKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var TextDocumentSaveReasonValidateSlice = []TextDocumentSaveReason{
...
func (this *TextDocumentSaveReason) Validate() error {
	for _, x := range TextDocumentSaveReasonValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var CompletionItemKindValidateSlice = []CompletionItemKind{
...
func (this *CompletionItemKind) Validate() error {
	for _, x := range CompletionItemKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var CompletionItemTagValidateSlice = []CompletionItemTag{
	CompletionItemTagDeprecated,
}

func (this *CompletionItemTag) Validate() error {
	for _, x := range CompletionItemTagValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var InsertTextFormatValidateSlice = []InsertTextFormat{
	InsertTextFormatPlainText,
	InsertTextFormatSnippet,
}

func (this *InsertTextFormat) Validate() error {
	for _, x := range InsertTextFormatValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var InsertTextModeValidateSlice = []InsertTextMode{
	InsertTextModeAsIs,
	InsertTextModeAdjustIndentation,
}

func (this *InsertTextMode) Validate() error {
	for _, x := range InsertTextModeValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var DocumentHighlightKindValidateSlice = []DocumentHighlightKind{
...
func (this *DocumentHighlightKind) Validate() error {
	for _, x := range DocumentHighlightKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var CodeActionKindValidateSlice = []CodeActionKind{
	CodeActionKindEmpty,
...
func (this *CodeActionKind) Validate() error {
	for _, x := range CodeActionKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var TraceValuesValidateSlice = []TraceValues{
	TraceValuesOff,
	TraceValuesMessages,
	TraceValuesVerbose,
}
...
func (this *TraceValues) Validate() error {
	for _, x := range TraceValuesValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var MarkupKindValidateSlice = []MarkupKind{
	MarkupKindPlainText,
	MarkupKindMarkdown,
}

func (this *MarkupKind) Validate() error {
	for _, x := range MarkupKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var PositionEncodingKindValidateSlice = []PositionEncodingKind{
...
func (this *PositionEncodingKind) Validate() error {
	for _, x := range PositionEncodingKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var FileChangeTypeValidateSlice = []FileChangeType{
...
func (this *FileChangeType) Validate() error {
	for _, x := range FileChangeTypeValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var WatchKindValidateSlice = []WatchKind{
	WatchKindCreate,
	WatchKindChange,
	WatchKindDelete,
}
...
func (this *WatchKind) Validate() error {
	for _, x := range WatchKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var DiagnosticSeverityValidateSlice = []DiagnosticSeverity{
...
func (this *DiagnosticSeverity) Validate() error {
	for _, x := range DiagnosticSeverityValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var CompletionTriggerKindValidateSlice = []CompletionTriggerKind{
...
func (this *CompletionTriggerKind) Validate() error {
	for _, x := range CompletionTriggerKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var SignatureHelpTriggerKindValidateSlice = []SignatureHelpTriggerKind{
...
func (this *SignatureHelpTriggerKind) Validate() error {
	for _, x := range SignatureHelpTriggerKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var CodeActionTriggerKindValidateSlice = []CodeActionTriggerKind{
	CodeActionTriggerKindInvoked,
	CodeActionTriggerKindAutomatic,
}

func (this *CodeActionTriggerKind) Validate() error {
	for _, x := range CodeActionTriggerKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var FileOperationPatternKindValidateSlice = []FileOperationPatternKind{
	FileOperationPatternKindFile,
	FileOperationPatternKindFolder,
}

func (this *FileOperationPatternKind) Validate() error {
	for _, x := range FileOperationPatternKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var NotebookCellKindValidateSlice = []NotebookCellKind{
	NotebookCellKindMarkup,
	NotebookCellKindCode,
}

func (this *NotebookCellKind) Validate() error {
	for _, x := range NotebookCellKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var ResourceOperationKindValidateSlice = []ResourceOperationKind{
...
func (this *ResourceOperationKind) Validate() error {
	for _, x := range ResourceOperationKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var FailureHandlingKindValidateSlice = []FailureHandlingKind{
...
func (this *FailureHandlingKind) Validate() error {
	for _, x := range FailureHandlingKindValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var PrepareSupportDefaultBehaviorValidateSlice = []PrepareSupportDefaultBehavior{
	PrepareSupportDefaultBehaviorIdentifier,
}

func (this *PrepareSupportDefaultBehavior) Validate() error {
	for _, x := range PrepareSupportDefaultBehaviorValidateSlice {
		if *this == x {
			return nil
		}
	}
...
var TokenFormatValidateSlice = []TokenFormat{
	TokenFormatRelative,
}

func (this *TokenFormat) Validate() error {
	for _, x := range TokenFormatValidateSlice {
		if *this == x {
			return nil
		}
	}
