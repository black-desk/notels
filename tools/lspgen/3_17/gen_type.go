...
func genEnumerations(model *MetaModel) {
	...
	enumerationGenFile.Write([]byte("// Code generated by \"lspgen\"; DO NOT EDIT\n"))
	enumerationGenFile.Write([]byte("package protocol\n"))
	for _, enum := range model.Enumerations {
		enumerationGenFile.Write([]byte(fmt.Sprintf("/* %s */\ntype %s any\n", enum.Documentation, goMethodName(enum.Name))))
	}
}
